  ...
  return (
    ...
    >
      <Space direction="vertical" size={14} style={{ width: "100%" }}>
        ...
        <div id="faq" style={{ scrollMarginTop: 88 }}>
            ...
            <Collapse
              ...
              items={[
                ...
                },
                {
                  ...
                  children: (
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      Each pass is valid for the duration stated at purchase
                      (e.g. 15 days). The validity starts from the date of
                      activation.
                    </Typography.Paragraph>
                  ),
                },
                ...
                },
                {
                  ...
                  children: (
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      Simply present your active digital pass before payment.
                      Each venue’s specific perk is outlined on its listing
                      page.
                    </Typography.Paragraph>
                  ),
                },
                ...
                },
                {
                  ...
                  children: (
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      ...
                      Sharing or duplicating the pass may result in
                      cancellation.
                    </Typography.Paragraph>
                  ),
                },
                {
                  ...
                  children: (
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      Politely show your active pass and ensure the offer is
                      still valid. If issues persist, contact our support team
                      with the venue name and time of visit.
                    </Typography.Paragraph>
                  ),
                },
              ]}
        ...
        <div id="refund-policy" style={{ scrollMarginTop: 88 }}>
        ...
        <div id="terms" style={{ scrollMarginTop: 88 }}>
          <Card size="small" title="Terms">
            <Space direction="vertical" size={10} style={{ width: "100%" }}>
              <div>
                <Typography.Text strong>1. Use of the Pass</Typography.Text>
                <Typography.Paragraph style={{ marginBottom: 0 }}>
                  The Ahangama Pass grants access to listed perks at
                  participating venues only during the validity period.
                </Typography.Paragraph>
              </div>
              ...
              <div>
                ...
                <Typography.Paragraph style={{ marginBottom: 0 }}>
                  Venues may change, suspend, or modify offers at any time. We
                  aim to keep listings accurate but cannot guarantee
              ...
              <div>
                ...
                <Typography.Paragraph style={{ marginBottom: 0 }}>
                  ...
                  Misuse, fraud, or disruptive behavior may result in
              ...
              <div>
                ...
                <Typography.Paragraph style={{ marginBottom: 0 }}>
                  We reserve the right to update pricing, offers, and terms at
                  any time.
                </Typography.Paragraph>
              </div>
            </Space>
        ...
        <div id="privacy" style={{ scrollMarginTop: 88 }}>
