...
export default function PartnershipMobile() {
    ...
    <div style={{ maxWidth: 720, margin: '0 auto' }}>
      ...
      <div style={{ marginTop: 16 }}>
        <Alert
          ...
          description="This uses a Netlify-compatible HTML form POST." 
        />
      </div>

      <Card style={{ marginTop: 16 }}>
        <form name="partnership" method="POST" data-netlify="true" onSubmit={onSubmit}>
          <input type="hidden" name="form-name" value="partnership" />
          <Space direction="vertical" size={12} style={{ width: '100%' }}>
            <Input name="name" placeholder="Name" required />
            <Input name="email" placeholder="Email" type="email" required />
            <Input.TextArea name="message" placeholder="Message" rows={4} required />
